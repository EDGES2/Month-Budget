// Month Budget/Views/Main/SidebarView.swift
import SwiftUI
import CoreData
...
private struct RenameCategory: View {
    ...
    private func renameCategory(oldName: String, newName: String, in context: NSManagedObjectContext, categoryDataModel: CategoryDataModel) {
...
private struct CategoryMaker: View {
    @Environment(\.managedObjectContext) private var viewContext
    @EnvironmentObject var categoryDataModel: CategoryDataModel
    @Environment(\.dismiss) var dismiss
